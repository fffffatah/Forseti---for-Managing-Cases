...
<?php
    ...
    if(isset($_POST["reg_button"])){
        ...
        if(!$hasError){
            addLawyer($pp, $fullname, $username, $email, $phone, $pass, $nid, $dob, $gender, $address, $city, $state, $zip);
        }
    }
    ...
    if(isset($_POST["update_button"])){
        ...
        if(!$hasError){
            updateLawyer($pp, $fullname, $dob, $address, $city, $state, $zip, $lawyer_id);
        }
    }
    ...
    function addLawyer($pp, $fullname, $username, $email, $phone, $pass, $nid, $dob, $gender, $address, $city, $state, $zip){
        $query="INSERT INTO users(ID, PP, FULLNAME, USERNAME, EMAIL, PHONE, PASS, NID, DOB, GENDER, ADDRESS, CITY, STATE, ZIP, TYPE) VALUES(user_id_seq.nextval,'$pp','$fullname','$username','$email','$phone','$pass','$nid','$dob','$gender','$address','$city','$state','$zip','lawyer')";
        doNoQuery($query);
    }

...
<html>
    <head>
        <title>Forseti - for Managing Cases</title>
                            ...
                            <div class="card border-success mb3 dropshadow" style="height:350px;width:250px">
                                ...
                                <div class="card-body">
                                    <div class="btn-group-vertical">
                                        ...
                                        <a class="btn btn-info text-left" href="client_registration.php"><i class="fas fa-users"></i> As Client</a><!--ADD YOUR HYPERLINK-->
                                    </div>
                                </div>
                            </div>
                        </td>

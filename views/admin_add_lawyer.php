<?php
    ...
    require_once '../controllers/admin_add_lawyer_controller.php';
?>
<center>
                            ...
                            <div class="card border-success mb3 dropshadow">
                                ...
                                <div class="card-body">
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2" align="center"><input class="btn btn-outline-success" type="submit" name="reg_button" value="Add"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
